...
location: Ottawa, ON
---
* Automated away a long-time productivity bottleneck by developing a Python tool to collect data across CENGN's private clouds and present it in an internal web app; now integrated into all future VM deployments
